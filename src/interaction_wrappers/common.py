...
#
#
#  Shared @njit helpers used by every interaction model. The saturation parameter
#  and excitation rate formulas were duplicated verbatim in 6/18/simple-18/4-level
#  wrappers; this module is the single source of truth.
#
#
#########################################################################################
