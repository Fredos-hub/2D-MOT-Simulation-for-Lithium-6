...
from src.magnetic_field import ZeemanField, IdealQuadrupoleField, DipoleBarMagneticField
import numpy as np
import csv
import pandas as pd
...
def build_simulation(filename: str = None, status_callback=None, stop_callback=None):
    ...
    elif params.magnetic_field_type == "IdealQuadrupoleField":
        B_field = IdealQuadrupoleField(gradient = params.field_gradient,
                                       delta_B=params.delta_B,
